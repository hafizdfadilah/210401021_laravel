        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href='<?php echo e(url('kategori/'.$item->id_kategori."/edit")); ?>' class="btn btn-warning btn-sm">Edit</a>
                        <form onsubmit="return confirm('yakin menghapus?')" action="<?php echo e(url('kategori/'.$item->id_kategori)); ?>" class="d-inline" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\pem framework\210401021_laravel\resources\views/kategori/index.blade.php ENDPATH**/ ?>