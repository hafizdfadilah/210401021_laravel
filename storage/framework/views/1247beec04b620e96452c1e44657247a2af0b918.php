...
<!-- START FORM -->
<form action='<?php echo e(url('artikel/'.$data->id_artikel)); ?>' method='post'>
    <?php echo csrf_field(); ?>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select type="radio" class="form-control" name="author" id="author" style="text-align: center;">
                    ...
                    <?php $__currentLoopData = $data3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($item3->nama); ?>"><?php echo e($item3->nama); ?></option>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\pem framework\210401021_laravel\resources\views/artikel/edit.blade.php ENDPATH**/ ?>